	...
	$.bgmp = {
		...
		addPlacemarks : function( map ) {
			...
			if ( bgmpData.markers.length > 0 ) {
				console.log(bgmpData);

				// console.log( bgmpData.markers);
...
// contains the datails of window......
			infoWindowContent = '<div class="' + $.bgmp.prefix + 'placemark"> <h3>' + title + '</h3> <div>' + details +'<a href="https://www.google.com/maps/place/'+latitude+','+longitude+'">Get Directions</a></div> </div>';
